 ...
 */
function getBaseSchema(schema: CustomZodAny): CustomZodAny {
	if ('innerType' in schema._def) {
		return getBaseSchema(schema._def.innerType as CustomZodAny)
	}
	if ('schema' in schema._def) {
		return getBaseSchema(schema._def.schema as CustomZodAny)
	}
	return schema
}
